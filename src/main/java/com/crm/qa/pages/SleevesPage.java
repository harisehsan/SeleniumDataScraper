...
public class SleevesPage extends TestBase {
   ...
   // List<String> SleevesProductPricelst = new ArrayList<>();
    ...
    String pageLink = "https://www.amazon.co.uk/Best-Sellers-Clothing-Mens-Long-Sleeve-Tops/zgbs/clothing/1731026031/ref=zg_bs_nav_ap_3_1731025031";

  public SleevesPage() throws FileNotFoundException {
...
//            SleevesProductPricelst.add("N/A");
    ...
    private void addingDataToCSV1() throws FileNotFoundException {
        try {
            PrintWriter pw = new PrintWriter(new File("D:\\Haris\\man fashion Web site\\Tops.csv"));
